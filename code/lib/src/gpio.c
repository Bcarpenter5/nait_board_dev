...
{
    // this choice was so that if something takes a 8 bit value it will be 0 or 1 
    // the register is 32 bits I dont want 10000000000000000000000000000000 to be cut down to 00000000 
    if (port->IDR & (1 << pin))
      return 1;
    return  0;
}
