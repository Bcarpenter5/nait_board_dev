 ...
 *---------------------------------------------------------------------------------------------------------------------------------------------------
 */
#if defined (ARM_STM32G0XX)
#  define IRMP_PORT_LETTER                      A
#  define IRMP_BIT_NUMBER                       8

#elif defined (ATMEL_AVR) || defined (__AVR_XMEGA__)                      // use PB6 as IR input on AVR
#  define IRMP_PORT_LETTER                      A
#  define IRMP_BIT_NUMBER                       8
 ...
 *---------------------------------------------------------------------------------------------------------------------------------------------------
 */
#elif defined (ARM_STM32)                                               // use GPIOA Pin 8 as IR input on STM32
#  define IRMP_PORT_LETTER                      A
#  define IRMP_BIT_NUMBER                       8
