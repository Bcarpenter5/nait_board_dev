...
void ssd1306_WriteCommand(uint8_t byte) {
    // ln 2363 in I2C HAL h
    // also check out 5642
    // 6598
    // I2C_address(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, I2C_WRITE);
    //HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x00, 1, &byte, 1, HAL_MAX_DELAY);
    
    I2C_CommandWrite(SSD1306_I2C_PORT, SSD1306_I2C_ADDR , 0x00, byte);
}

// Send data
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    // I2C_address(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, I2C_WRITE);
    I2C_MemWrite(SSD1306_I2C_PORT, SSD1306_I2C_ADDR , 0x40, buffer, buff_size);
